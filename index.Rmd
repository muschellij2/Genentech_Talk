...
## Tutorials and Workflows <img src="figure/tutorials.png" style="width:100%; display: inline; margin: auto;" alt="flow"> 
...
```{r cranlogs, cache = TRUE, eval = run_downloads}
if (!require(cranlogs)) {
  library(devtools)
...
dl = plyr::arrange(dl, plyr::desc(All_Time),
                   plyr::desc(Last_Week))
...
```{r dt_cranlogs, results = "asis", eval = run_downloads, dependson = "cranlogs"}
...
## 
<div class="left-half">
<img src="figure/varimp.png" style="width:120%;  display: block; margin: auto;" alt="varimp">
</div>
<div class="right-half">
