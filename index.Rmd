...
## Step 2: Create Predictors for each Sequence <img src="figure/ms_covariates.png" style="width:75%; display: block; margin: auto;" alt="Preds">  

## A package to do all this

- All processing located in `smri.process` package

<img src="figure/processing_code.png" style="width:75%; display: block; margin: auto;" alt="code">
...
- OASIS logistic regression with images and the interaction of the image with a 10mm$^3$ and 20mm$^3$ smoother [@oasis].  Does not include T1Post, but did include PD originally
...
<img src="figure/patient07_ranger_smoothed_phat.png" style="width:55%;  display: block; margin: auto;" alt="Median"> 
...
- Needs to be more accurate for a biomarker <br/><br/>
    - Location may also be relevant and not taken into account
- "Black hole" lesions using the T1-post image
